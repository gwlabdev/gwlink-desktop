...
GWlink is in beta and runs on macOS (Apple Silicon) and Windows. Request access at [gwlink.gwlab.cl/request-access](https://gwlink.gwlab.cl/request-access). Current version is **0.1.89**, see [CHANGELOG.md](CHANGELOG.md).
